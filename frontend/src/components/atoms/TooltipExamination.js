  ...
  return (
    <div>
      ...
      <UncontrolledTooltip placement="right" target="UncontrolledTooltipExample" style={{'min-width': '400px'}}>
        ...
        zobrazí zdravému uživateli, uživateli s některou z indikací, nebo v obou případech - podle toho zadejte věkové
        rozmezí pacienta, příp. jaké položky indikují, že se uživateli zobrazí vyšetření v pokročilém vyhledávání.
      </UncontrolledTooltip>
    </div>
  );
};
