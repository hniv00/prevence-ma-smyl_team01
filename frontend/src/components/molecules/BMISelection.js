  ...
  render() {
    return (
      ...
      <Row>
        <Col xs="0" sm="12" md="4">
          <h6>Zadej výšku</h6>
          <input type="number" min="120" max="260" class="inputBMI" value={this.props.height} onChange={this.handleChangeHeight}/>
        </Col>
        <Col xs="0" sm="12" md="4">
          <h6>Zadej váhu</h6>
          <input type="number" min="40" max="260" class="inputBMI" value={this.props.weight} onChange={this.handleChangeWeight}/>
        </Col>
        <Col xs="0" sm="12" md="4">
          <h6>Výsledné BMI</h6>
          <input class="inputBMI" value={this.calculateBMI()} />
        </Col>
      </Row>
      </div>
    );
