        ...
        <header style={{margin: '2%'}}>
          <Row>
            ...
            <Col xs="12" sm="12" md="8">
              <h1 style={{color: 'white', fontSize:'68px', marginBottom: '40px', marginTop: '120px'}}>
              Jsme #PrevenceMáSmysl
              </h1>
              <h4 style={{color: 'white', marginBottom: '120px'}}>
              Tým lékařů, studentů, nadšenců do zdravého životního stylu
              i obyčejných lidí, které zajímá lidské zdraví. <br/>
