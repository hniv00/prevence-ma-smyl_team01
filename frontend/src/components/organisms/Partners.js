  ...
  render() {
    ...
    <div>
      <Row>
        <Col xs="12" sm="8">
          <h5>Loono</h5>
          <p id="cssContent">Jedním z našich největších partnerů je <span className="decor">Loono</span>.
      ...
      <Row>
        <Col xs="12" sm="4">
          <img src={avon} className="imgRound" alt="Avon pochod"/>
        </Col>
        <Col xs="12" sm="8">
          <h5>Avon pochod</h5>
      ...
      <Row>
        <Col xs="12" sm="8">
          ...
          <p id="cssContent">Dalším z našich partnerů je <span className="decor">STK pro chlapy</span>.
          Až se chlapi začnou starat <span className="decor">o své zdraví jako o auta</span>, budeme mít vyhráno! Starejte se o své zdraví. Zajděte na prohlídku včas. Nepřehlížejte příznaky.
          Nunc tincidunt ante vitae massa. Nam quis nulla. Phasellus et lorem id felis nonummy placerat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Nullam sit amet magna in magna gravida vehicula. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quis nibh at felis congue commodo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Dum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
        </Col>
        <Col xs="12" sm="4">
          <img src={stk} className="imgRound" alt="Loono tým"/>
        </Col>
      </Row>
      <hr/>
      ...
      <Row>
        <Col xs="12" sm="4">
          <img src={rucenaprsa} className="imgRound" alt="Avon pochod"/>
        </Col>
        <Col xs="12" sm="8">
          <h5>Ruce na prsa</h5>
          <p id="cssContent">Hlavním cílem kampaně „Ruce na prsa“ je zvýšit povědomí o důležitosti <span className="decor">samovyšetření prsu</span> pro nejširší veřejnost. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Integer pellentesque quam vel velit. Praesent vitae arcu tempor neque lacinia pretium. Maecenas fermentum, sem in pharetra pellentesque, velit turpis volutpat ante, in pharetra metus odio a lectus. Aliquam in lorem sit amet leo accumsan lacinia. Etiam sapien elit, consequat eget, tristique non, venenatis quis, ante. Nunc tincidunt ante vitae massa. Nam quis nulla. Phasellus et lorem id felis nonummy placerat. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum. Nullam sit amet magna in magna gravida vehicula. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Donec quis nibh at felis congue commodo. Cum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus. Lum sociis natoque penatibus et magnis dis parturient montes, nascetur ridiculus mus.</p>
        </Col>
      </Row>
    </div>
  );
