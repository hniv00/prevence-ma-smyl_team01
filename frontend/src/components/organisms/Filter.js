...
export const Filter = (props) => {
  return (
    <div id="filtration">
      <Jumbotron>
        <Row>
          <Col xs="0" sm="12" md="3"><GenderSelection/></Col>
          <Col xs="0" sm="12" md="3"><AgeSelection/></Col>
          <Col xs="0" sm="12" md="3"><AnamnesisSelection/></Col>
          <Col xs="0" sm="12" md="3"><DiseaseSelection/></Col>
        </Row>
        <Row>
          <ShowAdvancedSearch/>
        </Row>
        <Row>
          <Col><FindPrevention/></Col>
        </Row>
      </Jumbotron>
    </div>
  );
